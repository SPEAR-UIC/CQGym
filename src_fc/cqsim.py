...
if __name__ == "__main__":
    ...
    p.add_option("--input_weight_file", dest="input_weight_file", type="string",
                 default="",
                 help="file name to read weights from")

    # 46
    p.add_option("--output_weight_file", dest="output_weight_file", type="string",
                 default="",
                 help="path to save weights for DeepRL model (not used if is_training is 0)")
    ...
    if inputPara['input_weight_file']:
        inputPara['input_weight_file'] = inputPara['path_fmt'] + \
            inputPara['input_weight_file']
